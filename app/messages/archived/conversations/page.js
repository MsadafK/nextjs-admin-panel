        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-6">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 rounded-lg border bg-card border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-orange-500`}
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className={`px-4 py-3 rounded-lg border bg-card border-border text-foreground focus:outline-none focus:ring-2 focus:ring-orange-500`}
            >
            ...
            >
              {filteredConversations.map((convo, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      <div className="relative">
                        <div className={`w-10 h-10 rounded-full bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center text-background font-semibold text-sm`}>
                  ...
                  <div className="ml-13 border-l-2 border-orange-200 dark:border-orange-800 pl-4">
                    ...
                    <div className="flex items-center justify-end space-x-2">
                      <button className="p-1 text-muted-foreground hover:text-orange-500 transition-colors">

        ...
        <AnimatePresence>
          {filteredMessages.length > 0 ? (
            ...
            >
              {filteredMessages.map((message, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      <div className="relative">
                        <div className={`w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-background font-semibold text-sm`}>
                  ...
                  <div className="ml-13 border-l-2 border-indigo-200 dark:border-indigo-800 pl-4">
            ...
            >
              ...
              <p className={`text-muted-foreground`}>Schedule some messages to see them here.</p>
            </motion.div>
          )}
        </AnimatePresence>
      </div>

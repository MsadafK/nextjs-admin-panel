      ...
      <div className="max-w-7xl mx-auto space-y-5">
              ...
              >
                <div className="w-full flex flex-col-reverse gap-1 h-48">
                  ...
                  <div className="relative w-full flex flex-col items-center">
                    ...
                    >
                      <div className="absolute -top-5 left-1/2 -translate-x-1/2 text-xs font-bold text-foreground">
                        {data.kras}
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-sm font-semibold text-foreground mt-4">{data.month}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{dept.totalKRAs} KRAs • {dept.completed} completed</p>
                    </div>
                    <div className="text-right">
                      <p className="text-lg font-semibold tracking-tight text-foreground">{dept.avgScore}%</p>
          ...
          >
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-base font-semibold text-foreground">Achievement Distribution</h2>
            </div>
              ...
              {achievementDistribution.map((range, index) => (
                <div key={range.range} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <span className="font-bold text-foreground">{range.count} KRAs</span>
                  ...
                  <div className="h-4 bg-muted rounded-full overflow-hidden">
                    ...
                    >
                      {range.percentage > 15 && (
                        <span className="text-xs font-bold text-background">{range.percentage}%</span>
                      )}
                    </motion.div>
                  </div>
                </div>
              ...
              <div className="pt-4 border-t border-border mt-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-muted rounded-lg">
                    <p className="text-xs text-muted-foreground mb-1">Total KRAs</p>
                    <p className="text-lg font-semibold tracking-tight text-indigo-600">156</p>
                  </div>
                  <div className="text-center p-3 bg-muted rounded-lg">
                    <p className="text-xs text-muted-foreground mb-1">Avg Score</p>
                    <p className="text-lg font-semibold tracking-tight text-green-600">84.5%</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          {keyInsights.map((insight, index) => (
            <div
              key={insight.title}
              className="bg-card rounded-xl p-5 shadow-sm border border-border hover:shadow-card transition-all"
            >
              <div className={`inline-flex p-3 rounded-lg bg-gradient-to-br ${insight.color} mb-3`}>
                <insight.icon className="text-background" size={20} />
              </div>
              <p className="text-xs text-muted-foreground mb-1">{insight.title}</p>
              <p className="text-base font-semibold text-foreground mb-1">{insight.value}</p>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
                />
              </div>
            </div>
          </div>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-base font-semibold mb-2">Performance Highlights</h3>
